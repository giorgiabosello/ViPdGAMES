...
if (isset($_GET['ord']) && $_GET['ord'] == '1') {
    $query=("SELECT * FROM videogiochi WHERE console = 'PC' OR console = 'Pc' OR console = 'pc' ORDER BY titolo ASC");
}
else if (isset($_GET['ord']) && $_GET['ord'] == '2') {
    $query = ("SELECT * FROM videogiochi WHERE console = 'PC' OR console = 'Pc' OR console = 'pc' ORDER BY prezzo ASC");
}
else{
    $query = ("SELECT * FROM videogiochi WHERE console = 'PC' OR console = 'Pc' OR console = 'pc' ORDER BY titolo ASC");
}
...
<head>
    ...
    <title>Negozio PC | ViPd GAMES</title>
