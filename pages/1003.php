<?php
session_start();
$codice='1003' ; //PER MICHELE: Inserisci qui il codice tra virgolette del gioco che dev 'essere identico al record nel DB
...
?>
    ...
    <head>
        ...
        <title>
            <?php echo "$line[titolo]"?> C O D Black OPS | ViPd GAMES</title>
