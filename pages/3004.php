<?php
session_start();
$codice='3004' ; //PER MICHELE: Inserisci qui il codice tra virgolette del gioco che dev 'essere identico al record nel DB
...
?>
    ...
    <head>
        ...
        <title>
            <?php echo "$line[titolo]"?> FIFA 15 | ViPd GAMES</title>
