<?php
session_start();
$codice='3002' ; //PER MICHELE: Inserisci qui il codice tra virgolette del gioco che dev 'essere identico al record nel DB
...
?>
    ...
    <head>
        ...
        <title>
            <?php echo "$line[titolo]"?> NFS Burnout Paradise| ViPd GAMES</title>
