<?php
session_start();
$codice='2004' ; //PER MICHELE: Inserisci qui il codice tra virgolette del gioco che dev 'essere identico al record nel DB
...
?>
    ...
    <head>
        ...
        <title>
            <?php echo "$line[titolo]"?> PES 2011 | ViPd GAMES</title>
