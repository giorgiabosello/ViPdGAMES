                        ...
                        <div class="custom-page-box-div">
                            ...
                            <div class="fieldset">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input class="gray-input" data-val="true" data-val-required="Last name is required." id="LastName" name="LastName" value="" type="text">
                                    </div>
                                    <div class="col-md-4">
                                        <span class="required">*</span>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 ">Data di Nascita:</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input class="gray-input" data-val="true" data-val-email="Wrong email" data-val-required="Email is required." id="Email" name="Email" value="" type="text">
                                    </div>
                                    <div class="col-md-4">
                                        <span class="required">*</span>
                            ...
                            <div class="fieldset">
                                ...
                                <div class="form-fields">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input checked="checked" class="check-box" data-val="true" data-val-required="'Newsletter' must not be empty." id="Newsletter" name="Newsletter" value="true" type="checkbox">
                                            <input name="Newsletter" value="false" type="hidden">
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <div class="fieldset">
                                ...
                                <div class="form-fields">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input class="gray-input" data-val="true" data-val-length="The password should have at least 6 characters." data-val-length-max="999" data-val-length-min="6" data-val-required="Password is required." id="Password" name="Password" value="" type="password">
                                        </div>
                                        <div class="col-md-4">
                                            <span class="required">*</span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input class="gray-input" data-val="true" data-val-equalto="The password and confirmation password do not match." data-val-equalto-other="*.Password" data-val-required="Password is required." id="ConfirmPassword" name="ConfirmPassword" value="" type="password">
                                        </div>
                                        <div class="col-md-4">
                                            <span class="required">*</span>
                            ...
                            <div class="buttons">
                                <input id="register-button" class="button-1 register-next-step-button btn btn-primary" value="Registrati" name="register-button" type="submit">
                            </div>
                        </div>
                    </div>
                </form>
