...
if (isset($_GET['ord']) && $_GET['ord'] == '1') {
    $query=("SELECT * FROM videogiochi WHERE console = 'XBOX' OR console = 'xbox' OR console = 'Xbox' ORDER BY titolo ASC");
}
else if (isset($_GET['ord']) && $_GET['ord'] == '2') {
    $query = ("SELECT * FROM videogiochi WHERE console = 'XBOX' OR console = 'xbox' OR console = 'Xbox' ORDER BY prezzo ASC");
}
else{
    $query = ("SELECT * FROM videogiochi WHERE console = 'XBOX' OR console = 'xbox' OR console = 'Xbox' ORDER BY titolo ASC");
}
...
<head>
    ...
    <title>Negozio XBOX | ViPd GAMES</title>
